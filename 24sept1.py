##python incident_analysis.py --csv_file input.csv --max_features 1000 --n_clusters_base 5 --ngram_max 2 --pattern_field description --stat_fields category,assignment_group --group_field assignment_group
...
def read_csv_with_encodings(uploaded_file, is_streamlit=True):
    ...
    for encoding in encodings:
        try:
            ...
            print_function(f"Parsing error with {encoding}: {str(e)}. Trying fallback CSV reader...", is_streamlit, warning=True)
...
if __name__ == "__main__":
    ...
    if 'streamlit' in sys.modules and hasattr(st, 'script_run_context'):
        ...
        parser.add_argument('--pattern_field', type=str, default=None, help="Column for pattern analysis (defaults to first text-like column)")
